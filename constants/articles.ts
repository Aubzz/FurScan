...
export const skinHealth101: ArticleCard[] = [
  {
    ...
    description:
      "Learn about mange, ringworm, and other common conditions affecting your furry friend",
    backgroundColor: Colors.orangeCard1,
    gradientColors: ["#FFF4ED", "#FFE5D4"],
    icon: "bug-outline",
    contentType: "article",
    intro:
      "Understanding common skin diseases in pets is crucial for early detection and treatment. This guide covers the most frequent conditions you may encounter.",
    sections: [
      {
    ...
    faq: [
      {
        ...
        answer:
          "Look for signs like excessive scratching, hair loss, redness, bumps, or changes in skin color. If symptoms persist for more than a few days, consult your veterinarian.",
      },
      {
        question: "Are skin diseases in pets contagious to humans?",
        answer:
          "Some conditions like ringworm can be contagious to humans. Always wash your hands after handling a pet with skin issues and consult your vet for proper diagnosis and treatment.",
      },
      {
        question: "Can I treat my pet's skin condition at home?",
        answer:
          "Mild cases may improve with proper grooming and care, but persistent or severe symptoms require veterinary attention. Never use human medications without consulting your vet.",
      },
    ],
  },
  {
    ...
    description:
      "Recognize symptoms before they become serious - early detection saves lives",
    backgroundColor: Colors.orangeCard2,
    gradientColors: ["#FFE5D4", "#FFD4B8"],
    icon: "eye-outline",
    contentType: "guide",
    intro:
      "Early detection of skin problems can prevent serious complications. Learn to recognize the warning signs that indicate your pet may need attention.",
    sections: [
      {
    ...
    faq: [
      {
        ...
        answer:
          "Perform a quick visual check during daily grooming. Look for any changes in skin appearance, unusual bumps, or signs of irritation. Regular checks help catch problems early.",
      },
      {
        question: "What should I do if I notice early warning signs?",
        answer:
          "Document the symptoms with photos, note when they started, and schedule a veterinary appointment. Early intervention often leads to better outcomes.",
      },
      {
        question: "Can behavioral changes indicate skin problems?",
        answer:
          "Yes, restlessness, excessive licking, or avoiding touch in certain areas can indicate discomfort or pain related to skin issues.",
      },
    ],
  },
  {
    ...
    contentType: "guide",
    intro:
      "Knowing when to seek professional veterinary care is essential for your pet's health. Some symptoms require immediate attention, while others can wait for a scheduled appointment.",
    sections: [
      {
    ...
    faq: [
      {
        ...
        answer:
          "Seek immediate care for open wounds, signs of infection (pus, foul odor), rapid symptom worsening, or if your pet shows systemic symptoms like fever or lethargy.",
      },
      {
        question: "How urgent are skin problems in pets?",
        answer:
          "Most skin issues can wait for a scheduled appointment, but open wounds, infections, or rapidly worsening conditions require immediate veterinary attention.",
      },
      {
        question: "What information should I bring to the vet?",
        answer:
          "Bring photos of the affected areas, notes on when symptoms started, any recent changes in diet or environment, and a list of current medications or treatments.",
      },
    ],
  },
  {
    ...
    description:
      "Separating common misconceptions from the truth about pet skin health",
    backgroundColor: Colors.orangeCard4,
    gradientColors: ["#FFC9A3", "#FFB380"],
    icon: "help-circle-outline",
    contentType: "article",
    intro:
      "There are many myths and misconceptions about pet skin health. Let's separate fact from fiction to help you make informed decisions about your pet's care.",
    sections: [
      {
        title: "Myth vs Fact",
        items: [
    ...
    faq: [
      {
        ...
        answer:
          "No, most skin allergies in dogs are lifelong conditions. However, they can be effectively managed with proper treatment, diet, and care under veterinary guidance.",
      },
      {
        question: "Can I use human products on my pet?",
        answer:
          "No, human products like shampoo, lotions, or medications are not safe for pets. They have different pH levels and ingredients that can cause serious skin irritation or toxicity.",
      },
      {
        question: "How do I know if my pet's scratching is normal?",
        answer:
          "Occasional scratching is normal, but excessive scratching, licking, or biting indicates a problem. If your pet is scratching enough to cause hair loss, redness, or sores, consult your veterinarian.",
      },
    ],
  },
];
...
export const preventionCare: ArticleCard[] = [
  {
    ...
    intro:
      "Regular grooming is essential for maintaining your pet's skin health. Follow this daily checklist to keep your furry friend healthy and happy.",
    sections: [
      {
    ...
    faq: [
      {
        ...
        answer:
          "Daily brushing is ideal for most pets. The frequency depends on your pet's coat type, but regular grooming helps maintain healthy skin and catch problems early.",
      },
      {
        question: "What tools do I need for grooming?",
        answer:
          "Use brushes appropriate for your pet's coat type. Consult your vet or groomer for specific recommendations. Always have treats on hand to make grooming positive.",
      },
      {
        question: "Can grooming prevent skin problems?",
        answer:
          "Yes, regular grooming removes dead hair, distributes natural oils, and helps you spot issues early. It also reduces the risk of matting and skin irritation.",
      },
    ],
  },
  {
    ...
    description:
      "How diet affects your pet's skin condition and overall wellness",
    backgroundColor: Colors.orangeCard1,
    gradientColors: ["#FFF4ED", "#FFE5D4"],
    icon: "medical-outline",
    contentType: "article",
    intro:
      "Proper nutrition plays a crucial role in maintaining healthy skin and coat. Learn how to feed your pet for optimal skin health.",
    sections: [
      {
    ...
    faq: [
      {
        ...
        answer:
          "Look for high-quality pet foods with adequate protein, omega-3 and omega-6 fatty acids, and essential vitamins like A, E, and zinc. Consult your vet for specific recommendations.",
      },
      {
        question: "Can food allergies cause skin problems?",
        answer:
          "Yes, food allergies are a common cause of skin issues. Common allergens include beef, dairy, wheat, and chicken. Your vet may recommend an elimination diet to identify triggers.",
      },
      {
        question: "Should I give my pet supplements for skin health?",
        answer:
          "Only under veterinary guidance. Omega-3 supplements can help, but always consult your vet before adding any supplements to your pet's diet.",
      },
    ],
  },
  {
    ...
    description:
      "Adapt your care routine throughout the year for optimal health",
    backgroundColor: Colors.orangeCard4,
    gradientColors: ["#FFC9A3", "#FFB380"],
    icon: "calendar-outline",
    contentType: "guide",
    intro:
      "Your pet's skin care needs change with the seasons. This guide helps you adapt your routine throughout the year for optimal health.",
    sections: [
      {
        title: "Spring Care",
        items: [
    ...
    faq: [
      {
        ...
        answer:
          "Increase parasite prevention in spring/summer, protect from sun and heat in summer, watch for dry skin in fall/winter, and adjust grooming frequency based on weather conditions.",
      },
      {
        question: "Do pets need different care in winter?",
        answer:
          "Yes, cold and dry air can cause skin dryness. Limit baths, use moisturizing shampoos, protect paws from ice and salt, and consider using a humidifier indoors.",
      },
      {
        question: "What about summer skin care?",
        answer:
          "Protect your pet from sunburn, especially on noses and ears. Keep them cool and hydrated, and watch for hot pavement that can burn paw pads.",
      },
    ],
  },
];
...
export const petCareBasics: ArticleCard[] = [
  {
    ...
    description:
      "How often and how to bathe your pet safely without causing irritation",
    backgroundColor: Colors.orangeCard3,
    gradientColors: ["#FFD4B8", "#FFC9A3"],
    icon: "water-outline",
    contentType: "guide",
    intro:
      "Proper bathing techniques are essential for maintaining your pet's skin health. Learn how to bathe your pet safely and effectively.",
    sections: [
      {
    ...
    faq: [
      {
        ...
        answer:
          "Most dogs need bathing every 4-6 weeks, but this varies by breed, activity level, and skin condition. Over-bathing can strip natural oils and cause dryness.",
      },
      {
        question: "Can I use human shampoo on my pet?",
        answer:
          "No, never use human shampoo. It's not pH-balanced for pets and can cause irritation. Always use pet-specific shampoos recommended by your veterinarian.",
      },
      {
        question: "What if my pet hates baths?",
        answer:
          "Make bathing positive with treats and praise. Use lukewarm water, be gentle, and consider professional grooming if your pet is very anxious about baths.",
      },
    ],
  },
  {
    ...
    description:
      "Protect your pet from parasites with effective prevention methods",
    backgroundColor: Colors.orangeCard2,
    gradientColors: ["#FFE5D4", "#FFD4B8"],
    icon: "shield-outline",
    contentType: "guide",
    intro:
      "Fleas and ticks can cause serious skin problems and transmit diseases. Effective prevention is key to keeping your pet healthy and comfortable.",
    sections: [
      {
    ...
    faq: [
      {
        ...
        answer:
          "Yes, even in winter. Parasites can survive indoors, and year-round prevention is the best way to protect your pet from diseases and skin problems.",
      },
      {
        question: "What's the best flea and tick prevention method?",
        answer:
          "The best method depends on your pet. Options include topical treatments, oral medications, collars, and sprays. Consult your veterinarian for the best option for your pet.",
      },
      {
        question: "What should I do if I find a tick on my pet?",
        answer:
          "Remove it immediately with tweezers, grasping close to the skin and pulling straight out. Clean the area with antiseptic and monitor for signs of infection or rash.",
      },
    ],
  },
  {
    ...
    description:
      "Essential guidelines for safe and effective pet grooming practices",
    backgroundColor: Colors.orangeCard1,
    gradientColors: ["#FFF4ED", "#FFE5D4"],
    icon: "checkmark-circle-outline",
    contentType: "guide",
    intro:
      "Grooming your pet at home can be a rewarding experience that helps you bond with your furry friend while keeping them healthy. Done right, it prevents mats, skin issues, and discomfort. Done wrong, it can be stressful for both of you. Here's a guide to the key dos and don'ts of home grooming.",
    sections: [
      {
        title: "Do's",
        items: [
    ...
    faq: [
      {
        question: "How often should I groom my pet?",
        answer:
          "Grooming frequency depends on your pet's breed, coat type, and lifestyle. Daily brushing is ideal for most pets, while bathing typically ranges from weekly to monthly. Consult your veterinarian for specific recommendations.",
      },
      {
        question: "Can I use human grooming products on my pet?",
        answer:
          "No, never use human products. They have different pH levels and ingredients that can cause skin irritation, dryness, or allergic reactions. Always use products specifically designed for pets.",
      },
      {
        question: "What should I do if my pet hates being groomed?",
        answer:
          "Make grooming positive with treats, praise, and short sessions. Start slowly, be patient, and consider professional grooming if needed. Never force grooming as it can create fear and stress.",
      },
    ],
  },
];
...
export const videoGuides: ArticleCard[] = [
  {
    ...
    description:
      "Learn how to identify and treat fungal infections in your dog with expert veterinary guidance",
    backgroundColor: Colors.orangeCard1,
    gradientColors: ["#FFF4ED", "#FFE5D4"],
    icon: "shield-checkmark-outline",
    contentType: "video",
    intro:
      "Fungal infections are a common skin problem in dogs that can cause discomfort and health issues. This video guide will teach you how to recognize the signs of fungal infections, understand the different types, and learn proper treatment methods to help your furry friend recover.",
    sections: [
      {
    ...
    faq: [
      {
        ...
        answer:
          "The video is approximately 15-20 minutes long and covers all essential information about dog skin diseases in an easy-to-understand format.",
      },
      {
        question: "Can I watch this on mobile?",
        answer:
          "Yes, the video is fully optimized for mobile viewing and can be watched on any device.",
      },
      {
        question: "Is this video suitable for beginners?",
        answer:
          "Absolutely! The video is designed for pet owners of all experience levels and explains complex topics in simple terms.",
      },
    ],
  },
  {
    ...
    description:
      "Comprehensive guide to treating and managing skin conditions in dogs",
    backgroundColor: Colors.orangeCard2,
    gradientColors: ["#FFE5D4", "#FFD4B8"],
    icon: "bandage-outline",
    contentType: "video",
    intro:
      "Proper skin care is essential for your dog's health and comfort. This video provides detailed guidance on identifying skin issues, understanding treatment options, and implementing effective care routines to keep your pet's skin healthy.",
    sections: [
      {
    ...
    faq: [
      {
        ...
        answer:
          "No, only minor infections should be treated at home. If your dog has severe symptoms, open wounds, or the infection is spreading, consult your veterinarian immediately.",
      },
      {
        question: "What supplies do I need?",
        answer:
          "The video will show you exactly what supplies are needed, typically including gentle cleansers, prescribed topical treatments, and clean bandages if necessary.",
      },
    ],
  },
  {
    ...
    description:
      "Expert tips for preventing skin diseases and maintaining healthy skin in dogs",
    backgroundColor: Colors.orangeCard3,
    gradientColors: ["#FFD4B8", "#FFC9A3"],
    icon: "heart-pulse-outline",
    contentType: "video",
    intro:
      "Preventing skin diseases is easier than treating them. This comprehensive video covers essential prevention strategies, early detection methods, and management techniques to help you keep your dog's skin healthy and problem-free.",
    sections: [
      {
    ...
    faq: [
      {
        ...
        answer:
          "Perform a quick visual check during daily grooming. A more thorough examination should be done weekly, especially if your dog is prone to skin issues.",
      },
      {
        question: "Can diet really prevent skin problems?",
        answer:
          "Yes! Proper nutrition with essential fatty acids, vitamins, and minerals plays a crucial role in maintaining healthy skin and preventing many common conditions.",
      },
    ],
  },
];
