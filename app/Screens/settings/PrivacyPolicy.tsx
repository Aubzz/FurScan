...
const POLICY_SECTIONS = [
  {
    ...
    title: 'Introduction',
    icon: 'info',
    content: 'This Privacy Policy explains how the system collects, uses, stores, and protects user and pet-related information. The system is designed to ensure transparency, data security, and responsible handling of information.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    content: 'This system is intended for educational and assistive purposes only and is not a substitute for professional veterinary diagnosis or treatment. Users are encouraged to consult a licensed veterinarian for medical concerns.',
  },
  {
    id: 10,
    title: 'Changes to Policy',
    icon: 'refresh-cw',
    content: 'This Privacy Policy may be updated to improve clarity or reflect system enhancements. Any changes will be made available within the system.',
  },
  {
    id: 11,
    title: 'Contact Information',
    icon: 'mail',
    content: 'For questions or concerns regarding this Privacy Policy, users may contact the system support team through the provided support channels.',
  },
];
...
const BackgroundStickers = () => (
  <View style={StyleSheet.absoluteFill} pointerEvents="none">
    ...
    <MaterialCommunityIcons name="file-document-outline" size={80} color="rgba(255,255,255,0.08)" style={{ position: 'absolute', top: 20, left: -20, transform: [{ rotate: '-15deg' }] }} />
