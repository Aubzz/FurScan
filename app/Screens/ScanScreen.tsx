...
import { ML_API_URL } from "../../constants/api";
import { useAssessment } from "../../contexts/AssessmentContext"; // Fixed Import
...
export default function ScanScreen() {
  ...
  const { updateAssessment } = useAssessment(); // Fixed: Destructuring
  ...
  const uploadToModel = async (uri: string) => {
    ...
    try {
      ...
      updateAssessment({
        scanImage: uri, // mapped 'uri' to 'scanImage'
        detectedLesions: data.predictions || [], // mapped API response to 'detectedLesions'
      });
