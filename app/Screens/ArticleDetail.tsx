...
const ArticleDetailScreen = () => {
  ...
  const articleData: ArticleData = params.articleData 
  ...
  const gradientColors = articleData.gradientColors as [string, string];
  ...
  const handleRelatedArticlePress = (relatedTitle: string) => {
    // Navigate to Insights screen with the article title
    // The Insights screen will find and navigate to the article
    router.push({
      pathname: '/Screens/Insights',
      params: {
        navigateToArticle: relatedTitle,
      },
    });
  };
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.breadcrumb}>
          ...
          >
            <Text style={styles.breadcrumbLink} numberOfLines={1}>Home</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            style={styles.breadcrumbItem}
          >
            <Text style={styles.breadcrumbLink} numberOfLines={1}>Insights</Text>
          </TouchableOpacity>
          <Text style={styles.breadcrumbSeparator}> {'>'} </Text>
        ...
        <View style={styles.metaSection}>
          <View style={styles.metaRow}>
            ...
            <View style={styles.metaItem}>
              ...
              <Text style={[styles.metaText, styles.metaTextVerified]}>Helpful Guide</Text>
            </View>
          </View>
        </View>
        ...
        {articleData.videoUrl && (
          <View style={styles.videoSection}>
            <View style={styles.videoHeader}>
              <Ionicons name="videocam" size={24} color={Colors.primaryOrange} />
              <Text style={styles.videoTitle}>Watch Video</Text>
            </View>
            {renderVideoPlayer()}
            <Text style={styles.videoDescription}>
              Learn more about {articleData.title.toLowerCase()} from expert veterinarians
            </Text>
          </View>
        )}
            ...
            {articleData.contentType === 'checklist' ? (
                ...
                {section.items.map((item, itemIndex) => (
                  <View key={itemIndex} style={styles.checklistItem}>
                    <View style={styles.checkbox}>
                      <Ionicons name="checkmark" size={16} color={Colors.primaryOrange} />
                    </View>
              ...
              <View style={styles.itemsContainer}>
                {section.items.map((item, itemIndex) => {
                  ...
                  const isReference = title.trim().toUpperCase() === 'REFERENCE';
                  ...
                  if (isReference) {
                    ...
                    const textBeforeUrl = hasUrl ? item.substring(0, item.indexOf(url)).trim() : item;
                  ...
                  const nextItem = itemIndex < section.items.length - 1 
                    ? section.items[itemIndex + 1] 
                    : null;
                  const isNextFact = nextItem && nextItem.trim().toUpperCase().startsWith('FACT:');
        ...
        {articleData.faq && articleData.faq.length > 0 && (
          <View style={styles.faqSection}>
            <View style={styles.faqHeader}>
              <Ionicons name="help-circle-outline" size={24} color={Colors.primaryOrange} />
              ...
              <View key={index} style={styles.faqItem}>
                <View style={styles.faqQuestionContainer}>
                  <View style={styles.faqQuestionIcon}>
                    <Ionicons name="help-circle" size={20} color={Colors.primaryOrange} />
                  </View>
              ...
              >
                <View style={styles.relatedItemLeft}>
                  <View style={styles.relatedIconContainer}>
                    <Ionicons name="document-text-outline" size={18} color={Colors.primaryOrange} />
                  </View>
...
const styles = StyleSheet.create({
  ...
  videoIframe: {
    ...
    height: '100%',
    borderRadius: 13,
  } as any, // Web-only style for iframe
  videoDescription: {
    fontSize: 14,
    color: Colors.textSecondary,
    textAlign: 'center',
