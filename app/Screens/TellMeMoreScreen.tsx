...
const QUESTIONS: any = {
  Q1: {
    ...
    no: "Q6",
    img: "dog1",
    hint: "Check if the skin is visible through the coat or if there are completely bald patches.",
  },
  Q2: {
    ...
    no: "Q4",
    img: "dog2",
    hint: "Look for hair loss that forms a distinct circle, like a coin or a target.",
  },
  Q3: {
    ...
    no: "Q4b",
    img: "dog3",
    hint: "Check if the skin looks like it's peeling or has a raised, red outer border.",
  },
  Q3a: {
    text: "Are other pets or humans in the house showing red, itchy skin spots?",
    statement:
      "Other humans or pets in household show similar red, itchy spots.",
    yes: "RINGWORM",
    no: "Q4b",
    img: "dog4",
    hint: "Ringworm is highly contagious; check if anyone else has developed circular rashes.",
  },
  Q4b: {
    ...
    no: "Q4",
    img: "dog5",
    hint: "Fungal (yeast) infections often smell like old gym socks or corn chips and make the coat greasy.",
  },
  Q4: {
    ...
    no: "DEMODECTIC MANGE",
    img: "dog6",
    hint: "Demodectic mange often causes bald spots (especially on the face/legs) without making the pet itchy at first.",
  },
  Q5: {
    text: "Is the scratching significantly more intense at night, or focused on the ear margins/elbows?",
    statement:
      "Scratching is intense at night or focused on ear margins/elbows.",
    yes: "SARCOPTIC MANGE",
    no: "Q6",
    img: "dog7",
    hint: "Sarcoptic mites cause intense, frantic itching that often wakes the pet up from sleep.",
  },
  Q6: {
    ...
    no: "Q9",
    img: "dog8",
    hint: "Look for 'obsessive' grooming or your pet acting restless.",
  },
  Q7: {
    ...
    no: "Q8",
    img: "dog9",
    hint: "Paw licking and face rubbing are the most common visible signs of environmental or food allergies.",
  },
  Q7a: {
    ...
    no: "Q8",
    img: "dog10",
    hint: "Think back to new treats, laundry detergents, or spring pollen.",
  },
  Q8: {
    ...
    no: "Q9",
    img: "dog11",
    hint: "Gently touch the skin; inflamed areas often feel warmer than the rest of the pet's body.",
  },
  Q8b: {
    ...
    no: "Q9",
    img: "dog12",
    hint: "Bacterial dermatitis often causes wet, weeping sores or sticky yellow crusts.",
  },
  Q9: {
    ...
    no: "Q11",
    img: "dog1",
    hint: "Mange, yeast, and allergies often start on the extremities and the muzzle.",
  },
  Q10: {
    ...
    no: "Q11",
    img: "dog2",
    hint: "Look for 'pustules'—tiny raised white or red bumps. These are classic signs of bacterial infection.",
  },
  Q11: {
    ...
    no: "Q13",
    img: "dog3",
    hint: "Chronic irritation (especially fungal yeast) causes skin to thicken like 'elephant skin' and turn dark.",
  },
  Q12: {
    ...
    no: "Q13",
    img: "dog4",
    hint: "Check for a 'sandpaper' texture or thick yellow/brown crusts on the skin.",
  },
  Q13: {
    ...
    no: "Q14",
    img: "dog5",
    hint: "Note if a small spot on a leg has moved to the chest or back over the last few days.",
  },
  Q14: {
    ...
    no: "Q15",
    img: "dog6",
    hint: "This helps rule out standard flea bites.",
  },
  Q15: {
    ...
    no: "Q16",
    img: "dog7",
    hint: "Allergies and yeast often return every year (seasonal).",
  },
  Q16: {
    ...
    no: "Q17",
    img: "dog8",
    hint: "Exposure to other animals increases the likelihood of contagious conditions like Sarcoptic Mange or Ringworm.",
  },
  Q17: {
    text: "If you gently rub the edges of the pet's ear flaps, does their back leg immediately start thumping?",
    statement:
      "Positive pinna-pedal reflex (back leg thumps when ear is rubbed).",
    yes: "Q18",
    no: "Q18",
    img: "dog10",
    hint: "This is called the 'pinna-pedal reflex' and is a very strong indicator of Sarcoptic Mange mites.",
  },
  Q18: {
    ...
    no: "FINISH",
    img: "dog11",
    hint: "Skin allergies and yeast infections frequently cause secondary ear infections.",
  },
};
...
export default function TellMeMoreScreen() {
  ...
  const calculateResult = useCallback(
    (allAnswers: any, finalPath: string) => {
      ...
      if (petAge) {
        ...
        if (
          ageString.includes("month") ||
          ageString === "1" ||
          ageString === "1 yr" ||
          ageString.includes("puppy")
        ) {
          isJuvenile = true;
        }
      }
      ...
      const scores: any = {
        Ringworm:
          (allAnswers.Q2 === "yes" ? 3 : 0) +
          (allAnswers.Q3 === "yes" ? 2 : 0) +
          (allAnswers.Q3a === "yes" ? 4 : 0) +
          (allAnswers.Q16 === "yes" ? 1 : 0),
        "Fungal Infection":
          (allAnswers.Q4b === "yes" ? 4 : 0) +
          (allAnswers.Q11 === "yes" ? 3 : 0) +
          (allAnswers.Q9 === "yes" ? 1 : 0) +
          (allAnswers.Q18 === "yes" ? 2 : 0),
        "Demodectic Mange":
          (allAnswers.Q1 === "yes" ? 2 : 0) +
          (allAnswers.Q4 === "no" ? 4 : 0) +
          (allAnswers.Q9 === "yes" ? 2 : 0) +
          (isJuvenile ? 3 : 0),
        "Sarcoptic Mange":
          (allAnswers.Q5 === "yes" ? 5 : 0) +
          (allAnswers.Q4 === "yes" ? 2 : 0) +
          (allAnswers.Q16 === "yes" ? 2 : 0) +
          (allAnswers.Q17 === "yes" ? 5 : 0),
        Hypersensitivity:
          (allAnswers.Q7 === "yes" ? 4 : 0) +
          (allAnswers.Q7a === "yes" ? 3 : 0) +
          (allAnswers.Q6 === "yes" ? 2 : 0) +
          (allAnswers.Q18 === "yes" ? 2 : 0),
        Dermatitis:
          (allAnswers.Q8 === "yes" ? 2 : 0) +
          (allAnswers.Q8b === "yes" ? 4 : 0) +
          (allAnswers.Q10 === "yes" ? 4 : 0) +
          (allAnswers.Q12 === "yes" ? 1 : 0),
      };
      ...
      let confidence =
        hasAnyYes && maxScore > 0
          ? Math.min(Math.round((maxScore / 7) * 100), 95)
          : 0;
    ...
    [router, imageUri, petName, petAge, petBreed, allResults],
  );
        ...
        if (Array.isArray(parsed)) {
          parsed.forEach((item: any) => {
            ...
            if (SKIP_QUESTIONS_MAP[label]) {
              ...
              SKIP_QUESTIONS_MAP[label].forEach((qId) => {
                initialAnswers[qId] = "yes";
              });
            }
          });
        }
  ...
  }, [allResults, calculateResult]);

  const findNextNonSkipped = (
    currentId: string,
    answer: "yes" | "no",
    skips: string[],
  ): string => {
    ...
    <SafeAreaView style={styles.container}>
          ...
          <View style={styles.explanationBubble}>
            ...
            <Text style={styles.bubbleText}>
              {autoDetected.length > 0 &&
                `Based on the ${autoDetected.join(", ")} we detected, `}
      ...
      <View style={styles.wrapper}>
        ...
        <View style={styles.centerArea}>
          <Image
            source={DOCTOR_IMAGES[QUESTIONS[questionId]?.img || "dog1"]}
            style={styles.mascot}
            resizeMode="contain"
          />
